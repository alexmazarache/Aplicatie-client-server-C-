...
namespace Client
{
    public partial class MainWindow : Form
    {
        ...
        private void PartTabel_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            int line_index = PartTabel.CurrentCell.RowIndex;

            NumePart.Text = PartTabel.Rows[line_index].Cells[1].Value.ToString();
            CapacitateBox.Text = PartTabel.Rows[line_index].Cells[2].Value.ToString();


        }

        private void CurseTabel_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
